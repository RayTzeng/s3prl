...
python speaker-level-MIA.py --base_path "/mnt/storage2/speech_data/LibriSpeech-Feature/" \
    --output_path "/mnt/storage1/privacy/s3prl/s3prl/privacy-analysis/attack/results_other_100/" \
    --model "pretrain_libri_reverse" \
    --unseen "VCTK"
